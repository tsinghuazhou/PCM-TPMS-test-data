...
df = load_and_process('tpms_gyroid20w_20260731_195755.csv')
...
stats_df.to_csv('stats_gyroid20w_20260731.csv', encoding='utf-8-sig')
print(f'统计数据已保存: stats_gyroid20w_20260731.csv')
