...
df = load_and_process('temperature_record_20260802_204933.csv')
...
stats_df.to_csv('stats_cooling_data.csv', encoding='utf-8-sig')
print(f'统计数据已保存: stats_cooling_data.csv')
