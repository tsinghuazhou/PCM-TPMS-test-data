...
df = load_and_process('tpms_gyroid10w_20260804_163501.csv')
...
stats_df.to_csv('stats_gyroid10w_20260804.csv', encoding='utf-8-sig')
print(f'统计数据已保存: stats_gyroid10w_20260804.csv')
